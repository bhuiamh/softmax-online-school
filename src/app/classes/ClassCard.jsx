          ...
          {classesData.map((data, index) => (
            ...
            >
              ...
              <div className="px-4 py-2">
                <h3 className="text-base md:text-xl font-bold text-green-700 mb-1">
                  {data.title}
                </h3>
                ...
                <p className="text-gray-800 mb-4" title={data.description}>
                  ...
                  {!expandedDescription[index] && (
                    <button
                      className="text-green-700 hover:text-green-900 focus:outline-none ml-1"
                ...
                <div className="flex justify-between">
                  {data.price > 0 && (
                    <div className="flex items-center font-bold">
                      <span className="text-green-700 text-base md:text-2xl">
                  ...
                  <div className="text-green-700 text-base md:text-2xl flex items-center font-bold">
