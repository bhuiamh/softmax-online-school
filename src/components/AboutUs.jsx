      ...
      <div className="max-w-screen-xl mx-auto p-6 md:p-10">
        ...
        <div className="">
          ...
          <div className="mt-10 md:mt-16">
            <p className="text-2xl font-semibold text-green-500 mb-3">
            ...
            <ul className="grid gap-3 gr">
              <li className="text-gray-700 text-base md:text-xl font-semibold flex items-start md:items-center group hover:text-gray-900 duration-300">
                <FaUsers className="mr-2 text-green-500 group-hover:text-green-700 duration-300 text-2xl" />
                Join our friendly online community and connect with other
                students.
              </li>
              <li className="text-gray-700 text-base md:text-xl font-semibold flex items-start md:items-center group hover:text-gray-900 duration-300">
                <FaQuestionCircle className="mr-2 text-green-500 group-hover:text-green-700 duration-300 text-xl" />
                Ask us any questions - we are always here to help!
              </li>
              <li className="text-gray-700 text-base md:text-xl font-semibold flex items-start md:items-center group hover:text-gray-900 duration-300">
                <FaMobile className="mr-2 text-green-500 group-hover:text-green-700 duration-300 text-xl" />
                Study anytime, anywhere with our handy SOS mobile app.
              </li>
              <li className="text-gray-700 text-base md:text-xl font-semibold flex items-start md:items-center group hover:text-gray-900 duration-300">
                <FaMoneyBillAlt className="mr-2 text-green-500 group-hover:text-green-700 duration-300 text-2xl" />
                Our courses are affordable so you can get a great education
                without breaking the bank.
              </li>
            </ul>
          </div>
          <a href="#_" class="mt-6 relative inline-block text-lg group">
            <span class="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-green-500 transition-colors duration-300 ease-out border-2 border-green-500 rounded-lg group-hover:text-white">
              ...
              <span class="absolute left-0 w-[270px] h-[270px] -ml-2 transition-all duration-300 origin-top-right -rotate-90 -translate-x-full translate-y-12 bg-green-500 group-hover:-rotate-180 ease"></span>
              <span class="relative"> Start Your Journey Now!</span>
            </span>
            <span
